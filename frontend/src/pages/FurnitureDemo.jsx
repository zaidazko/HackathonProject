      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            This is a separate component that demonstrates how to connect to the backend 
            furniture generation API without modifying the existing Home.jsx file.
          </p>
        </div>
        ...
        <div className="mt-8 p-6 bg-blue-50 rounded-lg">
          <h3 className="text-lg font-semibold text-blue-800 mb-2">How to Use This:</h3>
